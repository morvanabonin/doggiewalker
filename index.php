...
<html>
    <head>
        <title>Doggie Walker</title>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <meta content="Morvana Bonin" name="author">
        <meta content="Passeador de C&atilde;es" name="description">
	  ...
	  var _gaq = _gaq || [];
	  _gaq.push(['_setAccount', 'UA-30165827-1']);
        ...
        <div class="navbar navbar-inverse navbar-fixed-top" id="navbar">
            <div class="navbar-inner" id="navbar-inner">
                <div class="container">
                    ...
                    <a class="brand brand-img" id="brand" href="index.php">
                        <img src="img/logo.png" id="img-logo" alt="">
                        <div id="text-logo">Doggie Walker</div>
                    </a>
                ...
                <div class="row">
                    <div class="span12">
                        ...
                        <div class="carousel-inner">
                            ...
                            <a class="left carousel-control" href="#myCarousel" data-slide="prev"><div class="seta-esq">‹</div></a>
                        <a class="right carousel-control" href="#myCarousel" data-slide="next"><div class="seta-dir">›</div></a>
                    </div>
                    </div>
                </div>
